...
//     // NEW: retirement years so we can annotate
//     retirements: {
//       "Roger Federer": 2022,
//       "Rafael Nadal": 2024,
...
//       // UPDATED: clarify that 1 is best, no "lower is better" wording
//       const axisLabel = this.currentGender === "men"
...
//         // NEW: annotate retirement at the final year
...
//       // UPDATED: clearer, slightly pulsing instruction
//       let toggleHelp =
//         this.currentGender === "men"
//           ? "Click to view WTA (women)"
//           : "Click to view ATP (men)";
//       const pulse = 180 + 60 * Math.sin(p.frameCount * 0.08); // soft blink
//       p.textSize(11);
//       p.textAlign(p.CENTER, p.CENTER);
//       p.fill(120, pulse);
//       p.text(toggleHelp, cardX + panelW / 2, toggleY + toggleH + 14);
